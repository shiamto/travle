    ...
    "data": {
        ...
        "content": {
            "enjoy_section": {
                ...
                "sub_title": "LIKE NEVER BEFORE",
                "images": "Voluptatibus in inci"
            },
            "transforming_section": {
                "title": "Transforming Trips into Tales",
                "sub_title": "Wilh. Loesch Travel was born from a legacy of exploration and a dedication to sharing the world's wonders with fellow wanderers. With expertise in the travel industry, our team curates immersive journeys that reflect our passion for adventure, culture and authenticity. Every trip we plan is a testament to our commitment to excellence and personalized service.",
                "image": "Minim neque unde nis"
            },
            "partnership_section": {
                "title": "Our partnership with Makhan Bhog",
                "sub_title": "Our partnership with Makhan Bhog, founded in 2019, epitomizes our steadfast commitment to excellence. This esteemed alliance signifies our dedication to delivering unmatched destination management services with extraordinary experiences.",
                "images": "Est reiciendis aliqu"
            },
            "time": {
                "title": "Aut dolore sed et nu",
                "card": [
                    {
                        "image": "ewrw",
                        "title": "erwerwe"
                        ...
                        <div className="md:flex gap-6">
                            ...
                            <div className="basis-1/2  md:mt-0 mt-5">
                                <h1 className='md:text-[50px] text-[30px] font-barlow font-bold text-primary'>
                                    {aboutData?.data?.content?.transforming_section?.title}
                                </h1>
                                <p className=' leading-[30px]'>
                                    {aboutData?.data?.content?.transforming_section?.sub_title}
                                </p>
                                <div className="my-6">
                ...
                <div className="container mx-auto">
                    <div className="text-center max-w-[720px] mx-auto">
                        <h1 className='md:text-[50px] text-[30px] font-barlow font-semibold text-primary'>
                            {aboutData?.data?.content?.partnership_section?.title}
                        </h1>
                        <p className='leading-[25px] text-secondaryText py-3'>
                            {aboutData?.data?.content?.partnership_section?.sub_title}
                        </p>
                    </div>
