    ...
    return (
        <div className="flex flex-wrap justify-between mb-2">
            ...
            <ReactPaginate
                ...
                previousLinkClassName="text-sm bg-dark_text hover:bg-gray-600 text-white font-semibold py-2 px-4 rounded-l"
                nextLinkClassName="text-sm bg-dark_text hover:bg-gray-600 text-white font-semibold py-2 px-4 rounded-r"
                pageLinkClassName="text-sm bg-dark_text hover:bg-gray-600 text-white font-semibold py-2 px-4"
