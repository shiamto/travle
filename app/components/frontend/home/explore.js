...
const Explore = () => {
	return (
		<div className="py-8">
			<section className="bg-fixed bg-center bg-cover relative z-0" style={{ backgroundImage: "url('/explore.jpg')" }}>
				<div className="container px-4 mx-auto py-24 text-center relative z-[1]">
					<p className="text-white">Find the next place to visit</p>
					<h3 className="text-8xl text-white mb-6 font-semibold">Explore <span className="text-[#FF0143] font-bold">Vietnam</span></h3>
