        ...
        <div className="bg-[#ECEEEF] py-20">
            <div className='container'>
                    <header className="text-center max-w-[1150px] mx-auto">
                         <h1 className='text-[#ffa801] font-semibold text-lg'>Services</h1>
                        <h2 className="text-primary font-barlow text-[50px] font-semibold text-center">Tailored Experiences, Seamless Travel</h2>

                        <p className="text-base mt-2 text-secondaryText">We specialize in tailoring experiences to suit your unique travel style. Our services encompass meticulously planned itineraries, exclusive tours, luxury accommodations and expert guidance. Whether it's a solo expedition, a family getaway or a corporate retreat, our attention to detail ensures every moment of your journey is unforgettable.</p>
                    </header>
