...

                            {
                                Array.from({ length: 4 }).map((_, index) => <SwiperSlide key={index}>
                                    <div className='bg-white p-16 text-center space-y-5 relative rounded-lg'>
                                        ...
                                        <h1 className="text-2xl font-semibold font-custom">An Unforgettable Journey with Wilh. Loesch Travel!</h1>
                                        <p className='z-20 relative'> Our experience exploring Vietnam with Wilh. Loesch Travel was nothing short of phenomenal. As a team from Dahlia Technologies, we embarked on a corporate trip aiming to discover the beauty and culture of Vietnam, and Wilh. Loesch Travel ensured it was an unforgettable experience. </p>
                                    ...
                                    <div className='flex justify-center mt-8'>
                                        <div>
                                            ...
                                            <h1 className='text-base font-semibold text-center'>Dahlia User</h1>
                                        </div>
                                    </div>
                                </SwiperSlide>)
                            }
