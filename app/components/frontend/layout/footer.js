                ...
                <div className="mx-auto max-w-7xl container">
                    <div className="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
                        <div className="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8">
                            ...
                            <p className="text-base leading-relaxed text-white mt-7">Embark on a discovery journey with Wilh. Loesch Travel, crafting bespoke experiences that transcend the ordinary.</p>

                            <ul className="flex items-center space-x-3 mt-9">
                                <li>
                                    <a href="#" title="" className="flex items-center justify-center text-white transition-all duration-200 bg-primary rounded-full w-7 h-7 hover:bg-secondary focus:bg-secondary">
                        ...
                        <div>
                            ...
                            <ul className="mt-6 space-y-4">
                                <li>
                                    <a href="#" title="" className="flex text-base text-white transition-all duration-200 hover:text-secondary focus:text-secondary"> Home </a>
                                </li>
                                <li>
                                    <a href="#" title="" className="flex text-base text-white transition-all duration-200 hover:text-secondary focus:text-secondary"> About </a>
                                </li>

                                <li>
                                    <a href="#" title="" className="flex text-base text-white transition-all duration-200 hover:text-secondary focus:text-secondary"> Contact </a>
                                </li>

                                <li>
                                    <a href="#" title="" className="flex text-base text-white transition-all duration-200 hover:text-secondary focus:text-secondary"> Gallery </a>
                                </li>
                        ...
                        <div>
                            ...
                            <ul className="mt-6 space-y-4">
                                <li>
                                    <a href="#" title="" className="flex text-base text-white transition-all duration-200 hover:text-secondary focus:text-secondary"> Terms & Condition </a>
                                </li>

                                <li>
                                    <a href="#" title="" className="flex text-base text-white transition-all duration-200 hover:text-secondary focus:text-secondary"> Privacy Policy </a>
                                </li>

                                <li>
                                    <a href="#" title="" className="flex text-base text-white transition-all duration-200 hover:text-secondary focus:text-secondary"> Terms & Conditions </a>
                                </li>
